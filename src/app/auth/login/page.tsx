        ...
        <div className="grid w-full overflow-hidden rounded-3xl border border-border/60 bg-card shadow-sm lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="relative hidden overflow-hidden border-r border-border/60 bg-muted/20 p-10 lg:flex lg:flex-col lg:justify-between xl:p-14">
            ...
            <div className="relative my-auto py-16">
              ...
              <p className="mt-5 max-w-md text-sm leading-7 text-muted-foreground">
                Simplify your daily operations, save time, and keep your
                entire institute organized with one powerful management
                platform.
              </p>
              ...
              {/* Small feature card */}
              <div className="mt-10 flex max-w-md items-center gap-4 rounded-2xl border border-border/60 bg-background/70 p-4 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs leading-5 text-muted-foreground">
                    Your institute data stays protected and organized.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex items-center gap-2 text-xs text-muted-foreground">
              <span>© {new Date().getFullYear()} EduZen</span>
              <span className="size-1 rounded-full bg-border" />
              <span>Smart Coaching Management</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center p-6 sm:p-10 lg:p-12 xl:p-16">
            ...
            <div className="w-full max-w-md">
              ...
              {/* Mobile Brand */}
              <h2 className="text-2xl font-bold tracking-tight sm:text-3xl text-center mb-4">
                Welcome back
              </h2>
